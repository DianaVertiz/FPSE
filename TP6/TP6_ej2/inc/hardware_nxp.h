...
#define PORT_PIN_LED0  0x04  /**< Puerto del microcontrolador asociado al led DOUT0 */
#define PIN_LED0       0x04  /**< Pin del puerto 4 asociado al led DOUT0   */
#define GPIO_PORT_LED0 0x02  /**< Puerto del módulo GPIO asociado al led DOUT0 */
#define GPIO_PIN_LED0  0x04  /**< Identificación del pin asociado al led DOUT0 del módulo GPIO */
#define LED0_FUNC	   0X00	 /**< Funcion de configuracion del puerto P4_4 como gpio */

#define PORT_PIN_LED1  0x04  /**< Puerto del microcontrolador asociado al led DOUT1 */
#define PIN_LED1       0x05  /**< Pin del puerto 4 asociado al led DOUT1  */
#define GPIO_PORT_LED1 0x02  /**< Puerto del módulo GPIO asociado al led DOUT1 */
#define GPIO_PIN_LED1  0x05  /**< Identificación del pin asociado al led DOUT1 del módulo GPIO */
#define LED1_FUNC	   0X00	 /**< Funcion de configuracion del puerto P4_4 como gpio */

#define PORT_PIN_LED2  0x04  /**< Puerto del microcontrolador asociado al led DOUT2 */
#define PIN_LED2       0x06  /**< Pin del puerto 4 asociado al led DOUT2  */
#define GPIO_PORT_LED2 0x02  /**< Puerto del módulo GPIO asociado al led DOUT2 */
#define GPIO_PIN_LED2  0x06  /**< Identificación del pin asociado al led DOUT2 del módulo GPIO */
#define LED2_FUNC	   0X00	 /**< Funcion de configuracion del puerto P4_4 como gpio */

#define PORT_PIN_LED3  0x02  /**< Puerto del microcontrolador asociado al led DOUT3 */
#define PIN_LED3       0x01  /**< Pin del puerto 2 asociado al led DOUT3  */
#define GPIO_PORT_LED3 0x05  /**< Puerto del módulo GPIO asociado al led DOUT3 */
#define GPIO_PIN_LED3  0x01  /**< Identificación del pin asociado al led DOUT3 del módulo GPIO */
#define LED3_FUNC	   0X04	 /**< Funcion de configuracion del puerto P4_4 como gpio */

#define PORT_PIN_LED4  0x04  /**< Puerto del microcontrolador asociado al led DOUT4 */
#define PIN_LED4       0x08  /**< Pin del puerto 4 asociado al led DOUT4  */
#define GPIO_PORT_LED4 0x05  /**< Puerto del módulo GPIO asociado al led DOUT4 */
#define GPIO_PIN_LED4  0x0C  /**< Identificación del pin asociado al led DOUT4 del módulo GPIO */
#define LED4_FUNC	   0X04	 /**< Funcion de configuracion del puerto P4_4 como gpio */

#define PORT_PIN_LED5  0x04  /**< Puerto del microcontrolador asociado al led DOUT5 */
#define PIN_LED5       0x09  /**< Pin del puerto 4 asociado al led DOUT5  */
#define GPIO_PORT_LED5 0x05  /**< Puerto del módulo GPIO asociado al led DOUT5 */
#define GPIO_PIN_LED5  0x0D  /**< Identificación del pin asociado al led DOUT5 del módulo GPIO */
#define LED5_FUNC	   0X04	 /**< Funcion de configuracion del puerto P4_4 como gpio */

#define PORT_PIN_LED6  0x04  /**< Puerto del microcontrolador asociado al led DOUT6 */
#define PIN_LED6       0x0A  /**< Pin del puerto 4 asociado al led DOUT6  */
#define GPIO_PORT_LED6 0x05  /**< Puerto del módulo GPIO asociado al led DOUT6 */
#define GPIO_PIN_LED6  0x0E  /**< Identificación del pin asociado al led DOUT6 del módulo GPIO */
#define LED6_FUNC	   0X04	 /**< Funcion de configuracion del puerto P4_4 como gpio */

#define PORT_PIN_LED7  0x01  /**< Puerto del microcontrolador asociado al led DOUT7 */
#define PIN_LED7       0x05  /**< Pin del puerto 1 asociado al led DOUT7  */
#define GPIO_PORT_LED7 0x01  /**< Puerto del módulo GPIO asociado al led DOUT7 */
#define GPIO_PIN_LED7  0x08  /**< Identificación del pin asociado al led DOUT7 del módulo GPIO */
#define LED7_FUNC	   0X00	 /**< Funcion de configuracion del puerto P4_4 como gpio */

#define PORT_PIN_RGB   PORT_PIN_LED4  /** Para tener compatibilida con la edu-ciaa, mapeo el RGB en los leds 4,5, y 6, que estan los tres en el puerto 4*/
#define PIN_RGB_RED    PIN_LED4  /**< Pin del puerto 2 asociado al color rojo del led RGB   */
#define PIN_RGB_GRN    PIN_LED5  /**< Pin del puerto 2 asociado al color verde del led RGB   */
#define PIN_RGB_BLU    PIN_LED6  /**< Pin del puerto 2 asociado al color azul del led RGB   */

#define GPIO_PORT_RGB  GPIO_PORT_LED4  /**< Puerto del módulo GPIO asociado al led RGB */
#define GPIO_PIN_RED   GPIO_PIN_LED4  /**< Identificación del pin asociado al color rojo del LED RGB del módulo GPIO */
#define LED_RED_FUNC   LED4_FUNC	 /**< Funcion de configuracion del puerto P4_4 como gpio */
#define GPIO_PIN_GRN   GPIO_PIN_LED5  /**< Identificación del pin asociado al color verde del LED RGB del módulo GPIO */
#define LED_GRN_FUNC   LED5_FUNC	 /**< Funcion de configuracion del puerto P4_4 como gpio */
#define GPIO_PIN_BLU   GPIO_PIN_LED6  /**< Identificación del pin asociado al color azul del LED RGB del módulo GPIO */
#define LED_BLU_FUNC   LED6_FUNC	 /**< Funcion de configuracion del puerto P4_4 como gpio */
