...
void systemInit(void)
{
	...
	Chip_SCU_PinMux(PORT_PIN_LED0, PIN_LED0, MD_PUP, LED0_FUNC);
	Chip_SCU_PinMux(PORT_PIN_LED1, PIN_LED1, MD_PUP, LED1_FUNC);
	Chip_SCU_PinMux(PORT_PIN_LED2, PIN_LED2, MD_PUP, LED2_FUNC);
	Chip_SCU_PinMux(PORT_PIN_LED3, PIN_LED3, MD_PUP, LED3_FUNC);
	Chip_SCU_PinMux(PORT_PIN_LED4, PIN_LED4, MD_PUP, LED4_FUNC);
	Chip_SCU_PinMux(PORT_PIN_LED5, PIN_LED5, MD_PUP, LED5_FUNC);
	Chip_SCU_PinMux(PORT_PIN_LED6, PIN_LED6, MD_PUP, LED6_FUNC);
	Chip_SCU_PinMux(PORT_PIN_LED7, PIN_LED7, MD_PUP, LED7_FUNC);
	...
	Chip_GPIO_SetPinDIROutput(LPC_GPIO_PORT, GPIO_PORT_LED4, GPIO_PIN_LED4);
	Chip_GPIO_SetPinDIROutput(LPC_GPIO_PORT, GPIO_PORT_LED5, GPIO_PIN_LED5);
	Chip_GPIO_SetPinDIROutput(LPC_GPIO_PORT, GPIO_PORT_LED6, GPIO_PIN_LED6);
	Chip_GPIO_SetPinDIROutput(LPC_GPIO_PORT, GPIO_PORT_LED7, GPIO_PIN_LED7);
	...
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, GPIO_PORT_LED0, GPIO_PIN_LED0, FALSE);
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, GPIO_PORT_LED1, GPIO_PIN_LED1, FALSE);
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, GPIO_PORT_LED2, GPIO_PIN_LED2, FALSE);
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, GPIO_PORT_LED3, GPIO_PIN_LED3, FALSE);
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, GPIO_PORT_LED4, GPIO_PIN_LED4, FALSE);
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, GPIO_PORT_LED5, GPIO_PIN_LED5, FALSE);
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, GPIO_PORT_LED6, GPIO_PIN_LED6, FALSE);
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, GPIO_PORT_LED7, GPIO_PIN_LED7, FALSE);
